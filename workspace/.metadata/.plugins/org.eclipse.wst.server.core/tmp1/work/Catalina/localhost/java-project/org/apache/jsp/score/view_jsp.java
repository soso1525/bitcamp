 ...
 * Generated at: 2017-12-15 01:57:07 UTC
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("java100.app.domain.Score");
    _jspx_imports_classes.add("java100.app.dao.ScoreDao");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    PrintWriter out2 = new PrintWriter(out);
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class='form-group row'>\r\n");
      out.write("\t\t\t\t<label for='kor' class='col-sm-2 col-form-label'>국어</label>\r\n");
      out.write("\t\t\t\t<div class='col-sm-10'>\r\n");
      out.write("\t\t\t\t\t<input id='kor' type='number' class='form-control' name='kor'\r\n");
      out.write("\t\t\t\t\t\tvalue='");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class='form-group row'>\r\n");
      out.write("\t\t\t\t<label for='eng' class='col-sm-2 col-form-label'>영어</label>\r\n");
      out.write("\t\t\t\t<div class='col-sm-10'>\r\n");
      out.write("\t\t\t\t\t<input id='eng' type='number' class='form-control' name='eng'\r\n");
      out.write("\t\t\t\t\t\tvalue='");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class='form-group row'>\r\n");
      out.write("\t\t\t\t<label for='math' class='col-sm-2 col-form-label'>수학</label>\r\n");
      out.write("\t\t\t\t<div class='col-sm-10'>\r\n");
      out.write("\t\t\t\t\t<input id='math' type='number' class='form-control' name='math'\r\n");
      out.write("\t\t\t\t\t\tvalue='");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class='form-group row'>\r\n");
      out.write("\t\t\t\t<label for='sum' class='col-sm-2 col-form-label'>합계</label>\r\n");
      out.write("\t\t\t\t<div class='col-sm-10'>\r\n");
      out.write("\t\t\t\t\t<input readonly id='sum' type='text' class='form-control'\r\n");
      out.write("\t\t\t\t\t\tvalue='");
      out.print(score.getSum());
      out.write("'>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class='form-group row'>\r\n");
      out.write("\t\t\t\t<label for='aver' class='col-sm-2 col-form-label'>평균</label>\r\n");
      out.write("\t\t\t\t<div class='col-sm-10'>\r\n");
      out.write("\t\t\t\t\t<input readonly id='aver' type='text' class='form-control'\r\n");
      out.write("\t\t\t\t\t\tvalue='");
      out.print(score.getAver());
      out.write("'>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class='form-group row'>\r\n");
